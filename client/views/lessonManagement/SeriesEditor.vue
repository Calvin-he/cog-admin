...
export default {
  ...
  methods: {
    validateTitle () {
      this.$set(
        this.ctrl_title.errors,
        'required',
        this.isEmptyString(this.ctrl_title.value)
      )
      return !this.ctrl_title.errors.required
    },
    validatePrice () {
      this.$set(
        this.ctrl_price.errors,
        'required',
        this.ctrl_price.value == null
      )
      return !this.ctrl_price.errors.required
    },
    validateBanner () {
      this.$set(
        this.ctrl_bannerId.errors,
        'required',
        this.isEmptyString(this.ctrl_bannerId.value)
      )
    ...
    isModified () {
      return (
        this.ctrl_title.value !== this.series.title ||
    ...
    reset () {
      this.ctrl_title = {
        value: this.series.title,
        errors: {}
      }
      this.ctrl_desc = {
        value: this.series.desc,
        errors: {}
      }
      this.ctrl_price = {
        value: this.series.price,
        errors: {}
      }
      this.ctrl_noticeForPurchase = {
        value: this.series.noticeForPurchase,
        errors: {}
      }
      this.ctrl_bannerId = {
    ...
    submit () {
      ...
      let freeLessonIds = Object.keys(this.ctrl_freeLessons.value).filter(
        lid => this.ctrl_freeLessons.value[lid] === true
      )
      if (this.isNew()) {
        let data = {
        ...
        if (
          this.ctrl_noticeForPurchase.value !== this.series.noticeForPurchase
        ) {
